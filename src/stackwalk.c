...
NOINLINE size_t rec_backtrace_ctx(uintptr_t *bt_data, size_t* bt_size, size_t maxsize,
...
NOINLINE size_t rec_backtrace(uintptr_t *bt_data, size_t *bt_size, size_t maxsize, int skip, int add_interp_frames)
{
...
#ifdef LIBOSXUNWIND
NOINLINE size_t rec_backtrace_ctx_dwarf(uintptr_t *bt_data, size_t *bt_size, size_t maxsize,
